...
import 'package:google_docs/repository/local_storage_repostiory.dart';
import 'package:google_docs/screens/constants.dart';
...
class AuthRepository{
  ...
  Future<ErrorModel?> signInWithGoogle() async{
    ErrorModel error = ErrorModel(error: "Something unexpected", data: null);
    try{
      ...
      if(user != null){
        ...
        switch(res.statusCode){
          case 200:
            ...
            String? getToken = await _localStorageRepository.getToken();
            print(getToken);
            break;
        }
      }
